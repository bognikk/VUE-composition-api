<template>
  <section class="container">
    <user-data :first-name="user.firstName" :last-name="user.lastName" :age="user.userAge"></user-data>
    <!-- <h2>{{ uName }}</h2>
    <h3>{{ user.userAge }}</h3> -->
...
// setTimeout(function () {
//   // userName.value = 'Bogicevic';
//   // userAge.value = 33;
//   // user.value.userName = "Bogicevic";
//   // user.value.userAge = 33
//   user.userName = "Bogicevic";
//   user.userAge = 33;
// }, 2000);
